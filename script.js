const quizQuestions = [
  ...
  {
    question:
      "What is the size of an int data type in C (on most 32-bit systems)?",
  ...
  {
    question:
      "Which function is used to convert a string into an integer in JavaScript?",
    options: [
      "Number.toInt()",
      "parseInt()",
      "stringToInt()",
  ...
  {
    question:
      "Which built-in object is used to store key-value pairs in JavaScript?",
  ...
  {
    question:
      "Which CSS positioning value removes the element from normal document flow?",
  ...
  {
    question:
      "In C++, which STL container stores unique elements in sorted order?",
...
function showResult() {
  ...
  if (percentage >= 80) {
    resultMessage.textContent =
      "Excellent! You have a strong grip on these subjects.";
  } else if (percentage >= 50) {
    resultMessage.textContent =
      "Good job! A little more revision and you will master it.";
  } else {
    resultMessage.textContent =
